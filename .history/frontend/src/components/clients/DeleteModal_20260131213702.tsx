...
export function DeleteModal({ isOpen, onClose, onConfirm, clientName, loading = false }: DeleteModalProps) {
  return (
    <Modal isOpen={isOpen} onClose={onClose} backdropBlur={true} className="max-w-2xl">
      <div className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-md rounded-3xl border border-red-200/50 dark:border-red-900/50 shadow-2xl p-8">
        <div className="text-center mb-8">
          ...
          <p className="mt-3 text-gray-600 dark:text-gray-400">
            ...
            ? Cette action supprimera également toutes ses polices, véhicules, devis et quittances associés.
          </p>
        </div>
