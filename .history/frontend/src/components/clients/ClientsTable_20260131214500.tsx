...
export default function ClientsTable() {
  ...
  const getPermisColor = (typePermis: string): BadgeColor => {
    ...
    return colors[typePermis] || "light";
  };
      ...
      <div className="p-6 max-w-lg mx-auto">
        <div className="rounded-xl border border-error-200 bg-error-50 dark:border-error-500/30 dark:bg-error-500/10 p-6">
          <div className="flex items-start gap-3">
            <svg
              className="w-5 h-5 text-error-500 dark:text-error-400 mt-0.5"
              fill="currentColor"
              viewBox="0 0 20 20"
            >
              <path
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button
          ...
          className="bg-gradient-to-r from-brand-600 to-blue-light-600 hover:from-brand-700 hover:to-blue-light-700"
          startIcon={<AddIcon />}
        >
          Nouveau client
        </Button>
          ...
          <Table>
            <TableHeader className="bg-gray-50 dark:bg-gray-800/50">
              <TableRow>
                ...
                <TableCell
                  isHeader
                  className="py-4 px-6 font-semibold text-gray-700 dark:text-gray-300 text-right"
                >
                  Actions
                </TableCell>
              </TableRow>
                ...
                >
                  <TableCell className="py-4 px-6">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-brand-500/10 to-blue-light-500/10 dark:from-brand-500/20 dark:to-blue-light-500/20 flex items-center justify-center">
                        <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-brand-500 to-blue-light-600 dark:from-brand-600 dark:to-blue-light-700 flex items-center justify-center">
                  ...
                  <TableCell className="py-4 px-6">
                    <div className="flex items-center justify-end gap-2">
                      ...
                      <Button
                        ...
                        onClick={() => {
                          /* TODO: Naviguer vers les documents */
                        }}
                      >
                        <DocumentIcon />
                      </Button>
