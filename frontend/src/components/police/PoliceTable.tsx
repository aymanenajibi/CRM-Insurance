      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
            {polices.length} police{polices.length > 1 ? "s" : ""} · Gestion des
                      ...
                      <div className="space-y-1.5">
                        ...
                        <div className="text-xs text-gray-500 dark:text-gray-400">
                          {police.created_at && (
                            <>
                              Créée le{" "}
                              {new Date(police.created_at).toLocaleDateString(
                                "fr-FR",
                              )}
                            </>
                          )}
                        ...
                        {police.updated_at &&
                          police.updated_at !== police.created_at && (
                            <div className="text-xs text-gray-500 dark:text-gray-400">
                              Modifiée le{" "}
                              {new Date(police.updated_at).toLocaleDateString(
                                "fr-FR",
                              )}
                            </div>
                          )}
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 px-5 py-3">
            <div className="flex items-center justify-between">
              <div className="text-sm text-gray-600 dark:text-gray-400">
                Affichage de{" "}
                <span className="font-medium">{polices.length}</span> police
                {polices.length > 1 ? "s" : ""}
              </div>
              <div className="flex items-center gap-2">
